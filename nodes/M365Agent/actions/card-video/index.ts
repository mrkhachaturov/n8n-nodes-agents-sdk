...
const resourceDisplayOptions = { show: { resource: ['videoCard'] } };
const operationDisplayOptions = {
	show: { resource: ['videoCard'], operation: ['send', 'update'] },
};
...
export const description: INodeProperties[] = [
	{
		...
		options: [
			{ name: 'Send', value: 'send', action: 'Send a video card' },
			{ name: 'Update', value: 'update', action: 'Update a video card' },
		],
		default: 'send',
	},
	...
	{ ...buttonsField(), displayOptions: operationDisplayOptions },
	{
		...
		options: [
			...
			{ displayName: 'Autostart', name: 'autostart', type: 'boolean', default: false },
			{
				...
				type: 'string',
				default: '',
				placeholder: 'ISO-8601 like PT5M',
			},
			{
			...
			{ displayName: 'Shareable', name: 'shareable', type: 'boolean', default: true },
			{
				...
				default: '={}',
				typeOptions: { rows: 2 },
				description: 'Opaque object passed through as VideoCard.value',
			},
		],
	},
