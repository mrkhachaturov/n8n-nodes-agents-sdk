...
const resourceDisplayOptions = { show: { resource: ['audioCard'] } };
const operationDisplayOptions = {
	show: { resource: ['audioCard'], operation: ['send', 'update'] },
};
...
export const description: INodeProperties[] = [
	{
		...
		options: [
			{ name: 'Send', value: 'send', action: 'Send an audio card' },
			{ name: 'Update', value: 'update', action: 'Update an audio card' },
		],
		default: 'send',
	},
	...
	{ ...buttonsField(), displayOptions: operationDisplayOptions },
	{
		...
		options: [
			...
			{ displayName: 'Autostart', name: 'autostart', type: 'boolean', default: false },
			{
				...
				type: 'string',
				default: '',
				placeholder: 'ISO-8601 like PT2M30S',
			},
			{
			...
			{ displayName: 'Shareable', name: 'shareable', type: 'boolean', default: true },
			{
				...
				default: '={}',
				typeOptions: { rows: 2 },
				description: 'Opaque object passed through as AudioCard.value',
			},
		],
	},
