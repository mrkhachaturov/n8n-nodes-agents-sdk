...
const resourceDisplayOptions = { show: { resource: ['thumbnailCard'] } };
const operationDisplayOptions = {
	show: { resource: ['thumbnailCard'], operation: ['send', 'update'] },
};
...
export const description: INodeProperties[] = [
	{
		...
		options: [
			{ name: 'Send', value: 'send', action: 'Send a thumbnail card' },
			{ name: 'Update', value: 'update', action: 'Update a thumbnail card' },
		],
		default: 'send',
	},
